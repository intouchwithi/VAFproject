from VAFpackage import ThreeLevelModel, TwoLevelModel
import math
...
a1=np.arange(-100,0,1)
a2=np.arange(2,100,1)
...
#     t = TwoLevelModel(S0=S0, a=a, ecol_function=ecol_function, step_ea=0.1, step_mc=0.1)
#     t.find_equilibrium()
#     deg.append(degree)
