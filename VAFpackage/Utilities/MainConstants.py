...
FS_4_TYPES = {"Экологические\nтерритории": [31, 187, 189, 214, 215, 216, 219, 220],
              "Социальные\nтерритории": [58, 63, 66, 87, 171, 195, 200, 205, 203, 207],
              "Экономические\nтерритории": [12, 95, 103, 37, 38, 39, 43, 44, 45, 132, 135, 150, 186, 221, 222, 224],
              "Некадастрированные\nтерритории": [8888]}

"""dictionary for types corresponded to 6 main functional types"""
FS_7_TYPES = {"Водно-болотные\nугодья": [31, 187, 189, 214, 219, 220],
              "Леса": [215, 216],
              "Заливные\nлуга": [37, 39],
              "Хозяйственные\nзоны": [12, 38, 43, 44, 45, 95, 103, 132, 135, 150, 186, 221, 222, 224],
              "Жилые\nзоны": [58, 63, 66, 87, 171],
              "Рекреационные\nзоны": [195, 200, 203, 205, 207],
              "Некадастрированные\nтерритории": [8888]}
